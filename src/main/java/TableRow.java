...
import org.apache.hadoop.shaded.org.eclipse.jetty.websocket.common.scopes.DelegatedContainerScope;
...
public class TableRow {
    ...
    public Object[] Columns() { return _columns; }
    public ColumnType[] ColumnTypes() { return  _columnTypes; }
...
//                throw new ArgumentOutOfRangeException(nameof(type), type, null);
    ...
    public static TableRow Deserialize(MappedByteBuffer inputBuffer, ColumnType[] types) throws IOException, ClassNotFoundException {
        var columns = new Object[types.length];
...
//        try(FileWriter writer = new FileWriter("sizes.txt", false))
//        {
//            writer.write(" size " + _size +" rowSize " + _rowSize);
//            writer.flush();
//        }
